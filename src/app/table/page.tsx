...
import { Home, BarChart3, CreditCard, Zap, User, LogIn, UserPlus, Search, Settings, Bell, TrendingUp, MoreVertical, HelpCircle } from 'lucide-react';
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 px-3">
          <div className="mb-6">
            ...
            <NavItem icon={<BarChart3 size={20} />} label="Tables" active />
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 w-64"
                />
              </div>
        ...
        <div className="p-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
            <div className="p-6 border-b border-gray-100">
              <h3 className="text-xl font-bold text-gray-800">Authors Table</h3>
            </div>
                ...
                <tbody>
                  {authors.map((author, idx) => (
                    <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6">
                        <p className="text-sm text-gray-700">{author.employed}</p>
                      </td>
                      <td className="py-4 px-6">
                        <button className="text-sm text-gray-600 hover:text-teal-500 font-medium">
                          Edit
                        </button>
                      </td>
                    </tr>
                ...
                <tbody>
                  {projects.map((project, idx) => (
                    <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6">
                        <p className="text-sm font-semibold text-gray-700">{project.budget}</p>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 bg-gray-100 rounded-full h-2 overflow-hidden min-w-[150px]">
                            <div 
